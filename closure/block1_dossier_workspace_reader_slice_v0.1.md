...
- Exact implementation SHA and CI: pending for this increment; no remote
...
2. `YELLOW / B`: the ordinary launcher deliberately leaves the signed reader
   unconfigured; operator-safe key files, startup and recovery are next.
