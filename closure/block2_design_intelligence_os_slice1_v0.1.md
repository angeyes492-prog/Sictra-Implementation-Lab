...
| Project Graph SQLite | YELLOW | evidencia acumulada + E08 durable + CI 33575896009 | rollback/idempotencia/collision + memoria durable 8/8 | 2026-09-01 | 0.3 | review independiente | backend único | A local+CI | unittest + GitHub Actions | review externo |
...
| Regresión workspace | GREEN hosted | `block2_design_os_hosted_ci_2026-09-01.json` | 458/458 local + workflow completo | 2026-09-01 | SHA a19b4df | ninguna técnica para ese SHA | aceptación separada | A | unittest + GitHub Actions 33575896009 | nueva ejecución ante cambio material |
