...
| Project Graph SQLite | YELLOW | evidencia acumulada + ciclo E08 durable | rollback/idempotencia/collision + memoria durable 8/8 | 2026-09-01 | 0.3 | review independiente | backend único | A local | unittest local | review externo |
...
| Export HTML/SVG | YELLOW | `block2_export_render_audit_2026-09-01.md` | focal 5/5 + Edge normal/largo sin overflow | 2026-09-01 | 0.2 | clientes reales/revisión independiente | no publicación; correo no validado en clientes | A local | unittest + Edge | visual regression/cliente real |
...
| Memoria creativa E08 durable | YELLOW | `block2_e08_durable_memory_cycle_2026-09-01.md` | restart/deprecación/collision/rollback/tamper/concurrencia 8/8 | 2026-09-01 | 0.2 | revisión independiente | fixture y SQLite locales | A local | unittest local | CI exacto + review externo |
| Slice 1 completo | YELLOW | núcleo local E2E + CI anterior; memoria durable pendiente de CI exacto | Block2 169/169 + workspace 457/457 local | 2026-09-01 | 0.6 candidate | provider real/MAR/a11y humana/CI exacto nuevo | aceptación incompleta | B | unittest local | CI del SHA actual + cierre de dependencias |
