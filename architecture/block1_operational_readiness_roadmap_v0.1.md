...
| 3. Schema and quality | Map source fields and reject ambiguous, invalid or incomplete values. | Not implemented. | Eurostat mapper verifies metadata, header, geography, years, unit and missing markers. | Versioned mappers, drift alerts, reconciliation and rollback. |
