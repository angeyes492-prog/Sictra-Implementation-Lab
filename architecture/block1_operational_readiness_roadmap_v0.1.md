...
| 7. Watchlists and cadence | Recheck approved sources and surface meaningful change without noise. | Manual Eurostat release comparator implemented; no scheduler or durable checkpoint. | Defined cadence and a manually triggered, attested delta report for one source. | Budgeted workers, rate limits, change detection, alerts, kill switch and incident runbook. |
