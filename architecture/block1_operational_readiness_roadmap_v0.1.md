...
| 6. Editorial decisioning | Select only relevant, attributable insight candidates and hand off to Design. | Durable dossiers now enter the editorial contract through a conservative bridge and remain `RESEARCH_NEEDED`; reviewed, corroborated real candidates are not yet available. | One reviewed brief links every statement to evidence and abstains when weak. | Approval workflow, versioned outputs and publishing audit trail. |
