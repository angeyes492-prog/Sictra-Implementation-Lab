...
| GitHub | PR #11 mergeable, head `85e9d0b…`, CI `33826504086` `success`; no hay reviews | `VERIFIED / A` para CI/estado; `INSUFFICIENT EVIDENCE` para MAR/revisión humana | CI demuestra ejecución exacta, no aceptación global |
...
1. `sin HEAD / sin CI` era un checkpoint histórico; PR #11 y el run
   `33826504086` lo resuelven para el SHA exacto actual.
