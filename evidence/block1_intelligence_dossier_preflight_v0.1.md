...
bridge result generated two literal facts and no interpretations or hypotheses.
...
- Full regression and exact-SHA CI must be recorded after this increment is
  committed; until then this artifact is local evidence only.
